...
<head>
  ...
  ================================================== -->
	...
	<link href='<?php get_template_directory_uri() ?>/images/favicon.ico' rel='icon' type='image/x-icon'/>
...
<header>
	<div class="wrap-header zerogrid">
		<div id="logo"><a href="#"><img src="<?php get_template_directory_uri() ?>/images/logo.png"/></a></div>
		...
		<div class="slider">
			<div class="rslides_container">
				<ul class="rslides" id="slider">
					<li><img src="<?php get_template_directory_uri() ?>/images/slide1.png"/></li>
					<li><img src="<?php get_template_directory_uri() ?>/images/slide2.png"/></li>
					<li><img src="<?php get_template_directory_uri() ?>/images/slide3.png"/></li>
				</ul>
			</div>
		</div>
	</div>
