...
function NewsTicker_init(){
    ...
    // echo '<div class="ticker">The quick brown fox jumps over the lazy dog The quick brown fox jumps over the lazy dog The quick brown fox jumps over the lazy dog</div>';
