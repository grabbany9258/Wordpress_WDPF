                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4">
                            <div class="header__info">
                                <div class="logo">
                                    <a href="index.html" class="logo-image"><?php if(function_exists('the_custom_logo')) the_custom_logo()?></a>
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <div class="cart__inner d-flex">
                                                      <div class="cart__thumb">
                                                        <a href="product-details.html">
                                                          <img src="<?php echo get_template_directory_uri()?>/assets/img/cart/20.jpg" alt="">
                                                        </a>
                                                      </div>
                        ...
                        <div class="main-menu d-none d-lg-block">
                            <nav>
                                <ul>
                                        ...
                                        <div class="mega-menu">
                                            <div class="container container-mega">
                                                <ul>
                                                    ...
                                                    <li class="mega-image hover-effect" style="background-image: url(<?php echo get_template_directory_uri()?>/assets/img/bg/menu-item.jpg);"> 
                                                        <ul>
                                                          <li><a href="shop.html">
                                    ...
                                    <li><a href="blog.html" class="active">Blog <i class="far fa-angle-down"></i></a>
                                        <ul class="submenu">
    ...
    <div class="offcanvas__area">
        ...
        <div class="offcanvas__content">
            <div class="offcanvas__logo mb-40">
                <a href="index.html">
                <img src="<?php echo get_template_directory_uri()?>/assets/img/logo/logo-white.png" alt="logo">
                </a>
            </div>
