<footer>
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                ...
                                <div class="payment-image text-center mb-25">
                                    <a href="contact.html"><img src="<?php echo get_template_directory_uri()?>/assets/img/payment/payment.png" alt=""></a>
                                </div>
    ...
    <!-- footer-end -->
      ...
      <script src="<?php //echo get_template_directory_uri()?>/assets/js/ui-slider-range.js"></script>
