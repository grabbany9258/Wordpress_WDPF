...
$args['help_tabs'][] = array(
							...
							'content' => '<ul><li><a href="https://vibethemes.ticksy.com/" target="_blank">'.THEME_FULL_NAME.' Support Panel</a></li>
	                                          <li><a href="https://wplms.io/support/knowledge-base/one-click-setup-wplms-demo1/" target="_blank">'.THEME_FULL_NAME.' Theme Setup</a></li>
	                                          <li><a href="https://wplms.io/support/article-categories/faqs/" target="_blank">'.THEME_FULL_NAME.' Common FAQs/Issues</a></li>  
	                                          <li><a href="https://wplms.io/support/article-categories/tips-tricks/" target="_blank">'.THEME_FULL_NAME.' Tips and Tricks</a></li>
	                                          <li><a href="https://wplms.io/support/forums/forum/general/feature-request/" target="_blank">'.THEME_FULL_NAME.' Feature Requests</a></li>    
	                                          <li><a href="https://wplms.io/support/article-categories/update-log/" target="_blank">'.THEME_FULL_NAME.' Update Log</a></li>    
...
$args['help_sidebar'] = '<p>For Support/Help and Docuementation open <strong><a href="https://vibethemes.ticksy.com">'.THEME_FULL_NAME.' forums</a></strong>'.__('Or email us at','vibe').' <a href="mailto:vibethemes@gmail.com">vibethemes@gmail.com</a>. </p>';
...
$sections[] = array(
				...
				'desc' => '<p class="description">'.sprintf(__('Welcome to %s Theme Options panel. ','vibe'),THEME_FULL_NAME).'</p>
                                    <ol>
                                        ...
                                        <li>'.__('Facing issues? Create a support thread. ','vibe').' <a href="https://vibethemes.ticksy.com/" class="button" target="_blank">'.__('Full Theme Guide','vibe').'</a></li> 
                                        <li>'.__('How to Update? Facing Issues while updating?','vibe').' <a href="https://wplms.io/support/knowledge-base/auto-updating-wplms/">Auto updating WPLMS.</a></li>     
                                    </ol>
...
$sections[] = array(
				...
				'fields' => array(
                       ...
                       array(
						...
						'desc' => __('This Logo is shown in header on Mobile devices', 'vibe'),
                        'std' => VIBE_URL.'/assets/images/logo.png'
						),
                       array(
						'id' => 'alt_logo',
						...
						'desc' => __('This Logo is shown in header when it becomes fixed. ', 'vibe'),
                        'std' => VIBE_URL.'/assets/images/logo.png'
						),
                        array(
						'id' => 'favicon',
...
$sections[] = array(
				...
				'fields' => array(
					...
					array(
                        ...
                        'desc' => __('[Legacy v3 or below] Number of Buddypress items (Courses,Members,Groups,Forums,Blogs etc..)', 'vibe'),
                        'type' => 'text',
						'std' => '5'
						),
					array(
                        ...
                        'desc' => __('[Legacy v3 or below] Profile viewability : All {Non-Loggedin}, Members{Loggedin Members},Teachers {Teachers, Admins,Editors}', 'vibe'),
                        'type' => 'button_set',
					...
					array(
                        ...
                        'desc' => __('[Legacy v3 or below] Member Menu tabs like "Profile", "Activity","Groups" .. can be hidden', 'vibe'),
                        'type' => 'button_set',
					...
					array(
						'id' => 'members_redirect',
						'type' => 'pages_select',
                        'title' => __('[Legacy v3 or below] All Members no-access redirect Page', 'vibe'),
					...
					array(
                        ...
                        'desc' => __('[Legacy v3 or below] Activity viewability : All {Non-Loggedin}, Members{Loggedin Members},Teachers {Teachers, Admins,Editors}', 'vibe'),
                        'type' => 'button_set',
						'options' => array('0' => __('All','vibe'),'1'=>__('Members only','vibe'),'2' => __('Teachers only','vibe'),'3' => __('Admins only','vibe')),//Must provide key => value pairs for radio options
						'std' => '0'
						),
					array(
                        ...
                        'desc' => __('[Legacy v3 or below] Single activity visibility : All {Non-Loggedin}, Members{Loggedin Members},Teachers {Teachers, Admins,Editors}', 'vibe'),
                        'type' => 'button_set',
						'options' => array('0' => __('All','vibe'),'1'=>__('Members only','vibe'),'2' => __('Teachers only','vibe'),'3' => __('Admins only','vibe')),//Must provide key => value pairs for radio options
						'std' => '0'
						),
					array(
                        ...
                        'desc' => __('[Legacy v3 or below] Student can view only her activity', 'vibe'),
                        'type' => 'button_set',
					...
					array(
						...
						'type' => 'pages_select',
                        'title' => __('[Legacy v3 or below] Activity no-access redirect Page', 'vibe'),
                        'sub_desc' => __('User is redirected to this page on error.', 'vibe'),
					...
					array(
                        ...
                        'desc' => __('[Legacy v3 or below] Group directory viewability : All {Non-Loggedin}, Members{Loggedin Members},Teachers {Teachers, Admins,Editors}', 'vibe'),
                        'type' => 'button_set',
						'options' => array('0' => __('All','vibe'),'1'=>__('Members only','vibe'),'2' => __('Teachers only','vibe'),'3' => __('Admins only','vibe')),//Must provide key => value pairs for radio options
						'std' => '0'
						),	
					array(
						'id' => 'group_redirect',
						'type' => 'pages_select',
                        'title' => __('[Legacy v3 or below] Group directory no-access redirect Page', 'vibe'),
                        'sub_desc' => __('User is redirected to this page on error.', 'vibe'),
					...
					array(
                        ...
                        'sub_desc' => __('[Legacy v3 or below] Members meta-info is shown below the name', 'vibe'),
					...
					array(
                        ...
                        'desc' => __('[Legacy v3 or below] Group viewability : All {Non-Loggedin}, Members{Loggedin Members},Teachers {Teachers, Admins,Editors}', 'vibe'),
                        'type' => 'button_set',
						'options' => array('0' => __('All','vibe'),'1'=>__('Members only','vibe'),'2' => __('Teachers only','vibe'),'3' => __('Admins only','vibe')),//Must provide key => value pairs for radio options
						'std' => '0'
						),	
					...
					array(
                        ...
                        'desc' => __('[Legacy v3 or below] Join Group for Public groups and Request Membership button for private groups','vibe'),
					...
					array(
                        ...
                        'sub_desc' => __('[Legacy v3 or below] Enter the name of the Student Field to show below the name.', 'vibe'),
                        'std'=>'Location'
						),
					array(
                        ...
                        'sub_desc' => __('[Legacy v3 or below] Enter the name of the Instructor Field Group you want to hide from Students from viewing in Profile -> edit (* No Required fields & Case senstitive).', 'vibe'),
                        'std'=>'Instructor'
						),
                    array(
						'id' => 'instructor_field',
                    ...
                    array(
                        ...
                        'sub_desc' => '[Legacy v3 or below]'. sprintf(__('Add social profiles in user profiles. %s refer tutorial %s', 'vibe'),'<a href=" http://vibethemes.ticksy.com/knowledge-base/social-profile-field-group/ ">','</a>'),
                        'std'=>'Social Profiles'
						),
					array(
                    ...
                    array(
                        ...
                        'sub_desc' => '[Legacy v3 or below]'. __('Instructor Description is picked from this field in the Instructor Widget', 'vibe'),
                        'std'=>'About'
						),	
                    array(
                        ...
                        'desc' => '[Legacy v3 or below]'. __('Registration & Forgot password forms open inside login form.','vibe'),
                        'options' => array('' => __('Disable','vibe'),1=>__('Enable Login only','vibe'),2=>__('Enable Login and registration','vibe'))
						),
                    array(
						'id' => 'disable_vibebp_login',
						'type' => 'button_set',
                        'title' => __('Disable VibeBP Login', 'vibe'),
                        'sub_desc' => __('Enable/Disable JWT based login system', 'vibe'),
                        'desc' => __('VibeBP Login system is a secure and fast way to log into WPLMS sites. Users do not log into WP & perform limited functions.','vibe').'<a href="https://vibethemes.com/vulnerabilities-arising-from-wordpress-logged-in-traffic/">?</a>',
                        'options' => array('' => __('Enabled [ if VibeBP installed ]','vibe'),1=>__('Disable, use WP Login','vibe'))
						),
					array(
...
$sections[] = array(
				...
				'fields' => array(
                        ...
                        'desc' => '[Legacy v3 or below]'. sprintf(__('Course status page templates, %s tutorial %s', 'vibe'),'<a href="http://wplms.io/support/knowledge-base/course-status-templates/" target="_blank">','</a>'),
                        'type' => 'button_set',
                        ...
                        'desc' => sprintf(__('Location taxonomy for Courses in Course filters and Search %s Tutorial %s', 'vibe'),'<a href="https://wplms.io/support/knowledge-base/course-location-taxonomy/">','</a>'),
                        'type' => 'button_set',
						'options' => array('' => __('No','vibe'),'1'=>__('Yes','vibe')),
						'std' => ''
						),
                        ...
                        'desc' => sprintf(__('User redirects to Directory with category activated when she selects course category %s refer tutorial %s', 'vibe'),'<a href="https://vibethemes.ticksy.com/knowledge-base/course-category-redirect-to-course-directory/" target="_blank" class="link">','</a>'),
                        'type' => 'button_set',
						'options' => array('' => __('No','vibe'),'1'=>__('Yes','vibe')),
						'std' => ''
						),
                        ...
                        'desc' => '[Legacy v3 or below]'. __('Related courses are displayed based on category & instructor', 'vibe'),
                        'type' => 'button_set',
						'options' => array('0' => __('No','vibe'),'1'=>__('Yes','vibe')),
						'std' => '0'
						),
...
$sections[] = array(
				...
				'fields' => array(
					array(
                        ...
                        'sub_desc' => __('Required to fetch a list of Fonts from Google', 'vibe').'<a href="https://vibethemes.ticksy.com/knowledge-base/google-api-key-for-font-manager-and-usage/">Learn how to get Google fonts API</a>'
						),
					 array(
						'id' => 'google_fonts',
                        ...
                        'sub_desc' => __(' Custom Fonts are added to Theme Customizer Font List.. ', 'vibe').'<a href="https://wplms.io/support/knowledge-base/add-custom-fonts-in-wplms/">Learn how to add custom fonts</a>'
						)
...
$sections[] = array(
				...
				'fields' => array(
						...
						'desc' => __('Select page which you want to redirect users to when a user clicks on the site logo.','vibe'),
						),
						array(
						'id' => 'security_key',
						'type' => 'text',
						...
						'sub_desc' => __('Enter Google captcha public key', 'vibe').'<a href="https://wplms.io/support/knowledge-base/google-captcha-public-and-private-keys/">'.__('How to get an Public Key ?','vibe').'</a>',
						'std' => ''
						),
						array(
						...
						'sub_desc' => __('Enter Google captcha private key', 'vibe').'<a href="https://wplms.io/support/knowledge-base/google-captcha-public-and-private-keys/">'.__('How to get an Private Key ?','vibe').'</a>',
						'std' => ''
						),
						array(
						...
						'sub_desc' => __('Google Maps require an API key to function', 'vibe').'<a href="https://wplms.io/support/knowledge-base/how-to-get-google-api-key-for-google-maps/">'.__('How to get an API Key ?','vibe').'</a>',
						'std' => ''
						),
                       array(
						'id' => 'contact_ll',
...
$sections[] = array(
				...
				'fields' => array(
                       array(
						...
						'type' => 'demo_switcher',
                        'options' => array(
                        	'school' => array('Default' => __('Four Columns','vibe'), 'img' => esc_url('https://wplmsupdates.s3.amazonaws.com/demodata/demo_preview_images/school.png')),
