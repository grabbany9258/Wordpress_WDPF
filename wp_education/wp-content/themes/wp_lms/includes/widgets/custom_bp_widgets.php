...
class vibe_course_categories extends WP_Widget {
    ...
    if ( $title )
    echo vibe_sanitizer($before_title . $title . $after_title);
    ...
    function form($instance) {  
      ...
      $exclude_terms = esc_attr($instance['exclude_terms']);
        ...
        ?>
         ...
         <p>
          <label for="<?php echo vibe_sanitizer($this->get_field_id('title'),'text'); ?>"><?php _e('Title:','vibe'); ?></label> 
          <input class="regular_text" id="<?php echo vibe_sanitizer($this->get_field_id('title'),'text'); ?>" name="<?php echo vibe_sanitizer($this->get_field_name('title'),'text'); ?>" type="text" value="<?php echo vibe_sanitizer($title); ?>" />
        </p>
  		<p>
          <label for="<?php echo vibe_sanitizer($this->get_field_id('order'),'text'); ?>"><?php _e('Order by','vibe'); ?></label> 
           <select class="select" name="<?php echo vibe_sanitizer($this->get_field_name('order'),'text'); ?>">
        ...
        <p>
          <label for="<?php echo vibe_sanitizer($this->get_field_id('sort'),'text'); ?>"><?php _e('Sort Order ','vibe'); ?></label> 
           <select class="select" name="<?php echo vibe_sanitizer($this->get_field_name('sort'),'text'); ?>">
        ...
        <p>
          <label for="<?php echo vibe_sanitizer($this->get_field_id('hierarchial'),'text'); ?>">
          <input type="checkbox" id="<?php echo vibe_sanitizer($this->get_field_id('hierarchial'),'text'); ?>" name="<?php echo vibe_sanitizer($this->get_field_name('hierarchial'),'text'); ?>" value="1" <?php checked($hierarchial,1); ?>/><?php _e('hierarchial ','vibe'); ?></label> 
        </p>
        <p>
          <label for="<?php echo vibe_sanitizer($this->get_field_id('exclude_terms'),'text'); ?>"><?php _e('Exclude Course Category Terms slugs (comma saperated):','vibe'); ?></label> 
          <input class="regular_text" id="<?php echo vibe_sanitizer($this->get_field_id('exclude_terms'),'text'); ?>" name="<?php echo vibe_sanitizer($this->get_field_name('exclude_terms'),'text'); ?>" type="text" value="<?php echo vibe_sanitizer($exclude_terms); ?>" />
        </p>
