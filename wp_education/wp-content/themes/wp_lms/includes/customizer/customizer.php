    ...
    foreach($vibe_customizer['controls'] as $section => $settings){ $i=1;
        foreach($settings as $control => $type){
            ...
            $wp_customize->add_setting( 'vibe_customizer['.$control.']', array(
                                                ...
                                                'transport'  => 'refresh',
                                                'sanitize_callback'=> 'vibe_sanitizer',
...
function wplms_get_theme_color_config($theme){
    ...
    switch($theme){
        ...
        case 'dark':
            ...
            $option['body_bg'] = '#0d1e21';
            $option['body_bg'] = '#0d1e21';
            $option['content_bg'] = '#0d1e21';
            $option['single_dark_color'] = '#d0d0d0';
            $option['single_light_color'] = '#8e8e8e';
            $option['header_top_bg'] = '#03191d';
            $option['header_bg'] = '#08181b';
            $option['nav_bg'] = '#08181b';
            $option['footer_bg'] = '#08181b';
            $option['footer_bottom_bg'] = '#03191d';
            $option['content_link_color'] = '#f1f1f1';
            $option['content_color'] =  '#8e8e8e';
            $option['heading_color'] = '#8e8e8e';
            $option['single_dark_color'] =  '#001d23';
            $option['single_dark_text'] =  '#ffffff';
            $option['single_light_color'] =  '#05252d';
            $option['single_light_text'] =  '#8e8e8e';
            $option['header_top_color'] = '#acacac';
            $option['header_color'] = '#fff';
            $option['widget_title_color'] = '#8e8e8e';
            $option['nav_color'] = '#fff';
            $option['footer_color'] = '#8e8e8e';
            $option['footer_heading_color'] = '#bbb';
            $option['footer_bottom_color'] = '#acacac';
