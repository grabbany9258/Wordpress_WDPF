        ...
        <table id="socialtable" class="form-table">
           <?php
                ...
                foreach($icons as $value){
                    ...
                    <tr>
                <th>
                    <select name="social[icon][<?php echo vibe_sanitizer($i); ?>]"><?php
                ...
                <td>
                    <input type="text" name="social[link][<?php echo vibe_sanitizer($i); ?>]" id="author_url" value="<?php echo vibe_sanitizer($urls[$i]); ?>" class="regular-text" />
    ...
    public function social_sharing($tip_direction='top',$url = null){
        ...
        if(isset($social_share) && is_array($social_share)){
            ...
            foreach($social_share as $social){
                ...
                $output .='<li>';
                $output .= '<a href="'.$social_sharing[$social].'" '.$tip.' target="_blank" class="'.strtolower($social).((isset($show_social_tooltip) && $show_social_tooltip)?' tip':'').'"><i class="vicon vicon-'.strtolower($social).'"></i></a>';
                $output .='</li>';
            }
            $output .= '</ul>';
        }
