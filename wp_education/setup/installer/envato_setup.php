	...
	class Envato_Theme_Setup_Wizard {
		...
		public function init_globals() {
			...
			$this->features = array(
	                    		...
	                    		'batches'=>array(
	                    						...
	                    						'link'=>'https://vibethemes.ticksy.com/article-categories/wplms-batches/',
	                    						'verify'=>array('wplms-batches/loader.php')
                    						),
	                    		'attendance'=>array(
		...
		function envato_start_setup(){
            ...
            <form method="post">
                ...
                <hr><p><em>Have a suggestion for us. Share it with us <a href="https://vibethemes.ticksy.com/forums/forum/general/feature-request/" target="_blank">here</a>  !</em></p>
		...
		public function onboarding_step(){
			...
			if($this->step =='introduction'){
				...
				<a href="https://vibethemes.ticksy.com/knowledge-base/installing-wplms-version-4" target="_blank">Setup Wizard Video for Reference &rsaquo;</a>
				<?php
			}else{
		...
		public function setup_wizard() {
			...
			<span></span>
			<span>Having Troubles ? <a href="https://vibethemes.ticksy.com">Get Help</a></span>
			</div>';
		...
		public function envato_setup_updates_save(){
			...
			if(!empty($purchase_code)){
				...
				if(!empty($body) && $body['verify-purchase']['item_id'] == 6780226){
	...
	public function setup_wizard_header() {
		...
		public function envato_setup_default_content() {
			...
			<form method="post">
				...
				<hr><p><strong>Note</strong>&nbsp;&nbsp;If you do not see "Posts", "Pages" in import items section. Make sure to reload this page. Make sure you are connected to the internet  before content re-import. <br>Try <a href="<?php echo admin_url('themes.php?page=wplms-setup&step=default_content&force=1');?>">Load content from Alternate server</a> <br>Also see <a href="https://www.youtube.com/watch?v=xXMg6VjYoWw" target="_blank">video</a> or <a href="https://vibethemes.ticksy.com/knowledge-base/wplms-setup-wizard-import-content-not-loading/" target="_blank">document</a> help</a></p>
		...
		public function envato_setup_design() {
			...
			<form method="post">
				...
				<p><em>Please Note: WPLMS has live support at Facebook.com/VibeThemes. Also a free installation service at <a
							href="https://vibethemes.ticksy.com"
		...
		public function envato_setup_ready() {
			...
			<div class="envato-setup-next-steps">
				...
				<div class="envato-setup-next-steps-last">
					...
					<ul>
						<li class="documentation"><a href="https://vibethemes.ticksy.com/"
						...
						<li class="support"><a href="https://vibethemes.ticksy.com/"
