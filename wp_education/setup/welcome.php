...
class WPLMS_Admin_Welcome {
		...
		<div class="setup_wizard_wrapper">
			<div class="onboarding introduction">
				...
				<div class="onboarding_introduction">
					...
					<span><strong>14 Changes</strong>. 2 Enhancements . 12 Bug Fixes.</span>
				</div>
	...
	public function welcome_screen(){
		...
		<div class="welcome_slider">
		  	...
		  	<div class="slides">
		  		<div id="slide-1">
		  			<strong>Gutenberg Demo : Mooc <a href="https://demos.wplms.io/mooc" target="_blank">-></a></strong>
		  			<a href="https://demos.wplms.io/mooc" target="_blank"><img src="https://wplms.io/wp-content/uploads/2022/10/welcome_4.6.png" alt="wplms gutneberg app" /></a>
			    </div>
			    
			    <div id="slide-2">
		    		<img src="https://wplms.io/wp-content/uploads/2021/12/wplms_ios.png" alt="wplms ios app" />
			    </div>
			    <div id="slide-3">
		    		<img src="https://wplms.io/wp-content/uploads/2021/12/wplms_microsoft.png" alt="wplms windows app"  />
			    </div>
		  	</div>
	...
	public function support_screen(){
		...
		<div class="wplms_support_wrapper">
			<a href="https://vibethemes.ticksy.com" >Create a Support Topic</a>
		</div>
		<?php
	}
